...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 style="color: green;"><b>Create Coupons Code</b></h1>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control" placeholder="Enter Coupons Code" value="{{ old('code') }}">
                                    <p ></p>
                                    {{-- @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"  name="max_uses" id="max_uses"  class="form-control" placeholder="max_uses" value="{{ old('max_uses') }}">
                                    <p class="errors"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"  name="max_uses_user" id="max_uses_user"  class="form-control" placeholder="max_uses" value="{{ old('max_uses') }}">
                                    <p class="errors"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"  name="discount_amount" id="discount_amount"  class="form-control" placeholder="Discount amount" value="{{ old('max_uses') }}">
                                    <p class="errors"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text"  name="start_at" id="start_at"  class="form-control" placeholder="Enter start date" >
                                    <p class="errors"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text"  name="expire_at" id="expire_at"  class="form-control" value="{{ old('max_uses') }}">
                                    <p class="errors"></p>
                                </div>
                            </div>
                        </div>
